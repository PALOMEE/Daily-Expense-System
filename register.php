  ...
  <div class="signup-form">
    <form action="" method="POST" autocomplete="off">
      ...
      <div class="form-group">
        <div class="row">
          <div class="col"><input type="text" class="form-control" name="firstname" placeholder="First Name" required="required" pattern="[a-zA-z]+"></div>
          <div class="col"><input type="text" class="form-control" name="lastname" placeholder="Last Name" required="required" pattern="[a-zA-z]+"></div>
        </div>
      </div>
      <div class="form-group">
